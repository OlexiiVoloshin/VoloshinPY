...
class MarauderMap(MapMagic):
    ...
    def __create_json(self, films_awards=None, awards=None):
        import json
    ...
    def map_generator(self):
        ...
        print("Films and Awards:")
        for film in films_list:
            title = list(film.keys())[0]
            awards = film[title]
            print(f"\n{title}")
            for award in awards:
                print(f" - {award['award_name']}: {award['award']}")

        print("\n" + MapMagic._MapMagic__map_close)
